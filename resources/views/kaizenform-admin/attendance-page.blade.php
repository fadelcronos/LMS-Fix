                    ...
                    <div class="col-md-3">
                        <div class="border-0 shadow-lg rounded ml-2 mr-2">
                            ...
                            <div class="pt-2 pl-2 pr-2 pb-3">
                                <h5 class="text-dark font-weight-bold font2">Filter</h5>
                            ...
                            <div class="pl-2 pr-2 pb-3">
                                <label for="exampleSelect1" class="bmd-label-floating blk font2 font-weight-bold text-danger">Department</label>

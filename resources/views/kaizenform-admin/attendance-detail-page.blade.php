...
<div class="container" >
          ...
          <form class="user" method="post" action="{{ url('/kaizen-form/attendance') }}">
            @csrf
              ...
              <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      ...
                      <a class="nav-item nav-link active text-danger" id="nav-member-tab" data-toggle="tab" href="#nav-member" role="tab" aria-controls="nav-member" aria-selected="true">Members</a>
